...
import com.aproc.uberclonekotlin.databinding.ActivityTripInfoBinding
import com.aproc.uberclonekotlin.models.Prices
import com.aproc.uberclonekotlin.providers.ConfigProvider
...
class TripInfoActivity : AppCompatActivity(), OnMapReadyCallback, Listener, DirectionUtil.DirectionCallBack {
    ...
    //PERSONALIZANDO LA RUTA, COLOR Y ANIMACIÓN
    ...
    override fun onMapReady(map: GoogleMap) {
        ...
        easyDrawRoute() //Metodo que crea la ruta
        addOriginMarker() //Metodo que marca el origen
        addDestinationMarker() //Metodo que marca el destino
