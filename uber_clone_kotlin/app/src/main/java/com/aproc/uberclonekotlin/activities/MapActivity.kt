...
import com.aproc.uberclonekotlin.databinding.ActivityMapBinding
import com.aproc.uberclonekotlin.fragments.ModalBottomSheetMenu
import com.aproc.uberclonekotlin.models.Booking
import com.aproc.uberclonekotlin.models.DriverLocation
import com.aproc.uberclonekotlin.providers.AuthProvider
import com.aproc.uberclonekotlin.providers.BookingProvider
import com.aproc.uberclonekotlin.providers.ClientProvider
import com.aproc.uberclonekotlin.providers.GeoProvider
import com.aproc.uberclonekotlin.utils.CarMoveAnim
            ...
            override fun onKeyEntered(documentID: String, location: GeoPoint) {
                ...
                val marker = googleMap?.addMarker(
                    MarkerOptions().position(driverLatLng).title("Conductor disponible").icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.recycling) //uber_car
                    )
                )
...
//                            marker.position = LatLng(location.latitude, location.longitude)
    ...
    override fun onDestroy() { //CIERRA LA APLICACION O PASAMOS A OTRO ACTIVITY
        super.onDestroy()
